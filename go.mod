...
require (
	...
	github.com/openshift/api v0.0.0-20250812003733-213cdacfdadc // indirect
...
require (
	...
	github.com/ovn-org/ovn-kubernetes/go-controller v0.0.0-20250811215543-8f7fc5a1c8e4 // indirect
